...
# 90-day nurture sequence: (step, day_offset, subject, body_text)
# Reduced & spread (2026-09-07) from the old 12-email / 30-day blast into a
# calmer ~90-day cadence for an anxious accidental-trustee audience:
#   - max 2 emails in the first 7 days (day 0 + day 3) â the front stays light
#   - then ~12 emails total across 90 days, none closer than 5 days after day 7
# Kept + re-added emails are Kenneth-signed and carry the book-a-call CTA.
NURTURE_SEQUENCE = [
