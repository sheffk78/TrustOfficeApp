...
async def export_benevolence_pdf(
    ...
    tax_label = {"501c3": "501(c)(3) Organization (Tax-Exempt, Files Form 990)", "508": "508 Church/Religious Org (Tax-Exempt — No IRS Filings)", "private": "Private Trust (Full Tax Calendar — Form 1041)"}.get(tax_status, tax_status)
