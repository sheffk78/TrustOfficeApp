...
ACTION_REGISTRY = {
    ...
    "add_asset": {
        ...
        "fields": [
            {"name": "asset_type", "type": "string", "required": True, "description": "Category of asset (real_property, personal_property, financial_accounts, business_interests, digital_assets, intellectual_property, notes_receivable, other_property)"},
    ...
    "contribute_asset": {
        "type": "contribute_asset_preview",
        "requires_write": True,
        "confirmation_required": True,
        "description": "Accept/contribute an asset into the trust, creating both a Schedule A entry and acceptance resolution minutes",
        "api_endpoint": "POST /api/schedule-a + POST /api/minutes",
        "fields": [
            {"name": "asset_type", "type": "string", "required": True, "description": "Category of asset (real_property, personal_property, financial_accounts, business_interests, digital_assets, intellectual_property, notes_receivable, other_property)"},
            {"name": "description", "type": "string", "required": True, "description": "Description of the asset"},
            {"name": "value", "type": "number", "required": False, "description": "Estimated value of the asset"},
            {"name": "date_acquired", "type": "string", "required": True, "description": "Date the asset was contributed to the trust"},
            {"name": "meeting_date", "type": "string", "required": True, "description": "ISO date of the trustee meeting accepting the asset"},
            {"name": "participants", "type": "list", "required": True, "description": "List of meeting participants (trustees)"},
            {"name": "grantor_name", "type": "string", "required": False, "description": "Name of the person contributing the asset (if different from trustee)"},
            {"name": "ownership_pct", "type": "number", "required": False, "description": "Trust's ownership percentage"},
        ],
    },
    "update_asset": {
        "type": "asset_update_preview",
        "requires_write": True,
        "confirmation_required": True,
        "description": "Update the value or details of an existing asset on Schedule A",
        "api_endpoint": "PUT /api/schedule-a/{item_id}",
        "fields": [
            {"name": "asset_description", "type": "string", "required": True, "description": "Description or name of the asset to update (used to look up the existing record)"},
            {"name": "new_value", "type": "number", "required": False, "description": "New estimated value of the asset"},
            {"name": "new_description", "type": "string", "required": False, "description": "Updated description if changing"},
            {"name": "valuation_date", "type": "string", "required": False, "description": "Date of the re-valuation (defaults to today)"},
            {"name": "notes", "type": "string", "required": False, "description": "Notes about the valuation update"},
        ],
    },
    "create_distribution": {
    ...
    "setup_compensation": {
        ...
        "fields": [
            ...
            {"name": "annual_amount", "type": "number", "required": True, "description": "Annual compensation amount"},
            {"name": "fee_type", "type": "string", "required": True, "description": "Fee type: fixed, hourly, or per_meeting"},
            {"name": "effective_date", "type": "string", "required": True, "description": "Date compensation takes effect (YYYY-MM-DD)"},
            {"name": "role", "type": "string", "required": False, "description": "Trustee role or title"},
        ],
    },
    "record_compensation_payment": {
        "type": "compensation_payment_preview",
        "requires_write": True,
        "confirmation_required": True,
        "description": "Record a compensation payment to a trustee",
        "api_endpoint": "POST /api/compensation-payments",
        "fields": [
            {"name": "trustee_name", "type": "string", "required": True, "description": "Name of the trustee receiving payment"},
            {"name": "amount", "type": "number", "required": True, "description": "Payment amount"},
            {"name": "date", "type": "string", "required": True, "description": "Date of payment (YYYY-MM-DD)"},
            {"name": "classification_text", "type": "string", "required": False, "description": "Description or purpose of payment"},
        ],
    },
    "add_investment": {
        ...
        "api_endpoint": "POST /api/trusts/{trust_id}/investments",
        "fields": [
            {"name": "asset_name", "type": "string", "required": True, "description": "Name or ticker of the asset"},
            {"name": "asset_type", "type": "string", "required": True, "description": "Asset type: stock, bond, reit, crypto, real_estate, other"},
            {"name": "cost_basis", "type": "number", "required": True, "description": "Purchase price / cost basis"},
            {"name": "purchase_date", "type": "string", "required": True, "description": "Date purchased (YYYY-MM-DD)"},
            {"name": "current_value", "type": "number", "required": False, "description": "Current market value (defaults to cost_basis)"},
            {"name": "quantity", "type": "number", "required": False, "description": "Number of shares/units/coins/sqft"},
            {"name": "unit", "type": "string", "required": False, "description": "Unit type: shares, units, sqft, coins"},
            {"name": "custodian", "type": "string", "required": False, "description": "Where the asset is held (Fidelity, Schwab, etc.)"},
    ...
    "schedule_task": {
        ...
        "fields": [
            {"name": "task_type", "type": "string", "required": True, "description": "Type of task (annual_review, quarterly_review, compensation_review, asset_revaluation, distribution_review, insurance_compliance, transaction_review, tax_filing_1041, tax_filing_k1, custom)"},
    ...
    "create_entity": {
        ...
        "requires_write": True,
        "confirmation_required": True,
        "description": "Create a new entity (Trust, Holding LLC, or Operating LLC) in the Structures section",
        "api_endpoint": "POST /api/entities",
        "fields": [
            {"name": "name", "type": "string", "required": True, "description": "Entity name"},
            {"name": "entity_type", "type": "string", "required": True, "description": "Entity type: Trust, Holding LLC, or Operating LLC"},
            {"name": "legal_name", "type": "string", "required": False, "description": "Full legal name of the entity"},
            {"name": "governing_law", "type": "string", "required": False, "description": "State law governing the entity (2-letter state code)"},
            {"name": "ein", "type": "string", "required": False, "description": "Employer Identification Number"},
            {"name": "formation_date", "type": "string", "required": False, "description": "Date the entity was formed (ISO format)"},
            {"name": "trustee_names", "type": "string", "required": False, "description": "Names of trustees (for Trust entities)"},
            {"name": "member_names", "type": "string", "required": False, "description": "Names of members (for LLC entities)"},
            {"name": "manager_names", "type": "string", "required": False, "description": "Names of managers ( for LLC entities)"},
        ],
    },
    "general_chat": {
