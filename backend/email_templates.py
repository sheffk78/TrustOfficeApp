...
The TrustOffice Team
    ...
    "booking_confirmation": {
        ...
        "html": lambda data: _base_template(f"""
            ...
            <p>Hi {data.get('name', 'there')},</p>
            <p>Just a quick heads-up that your 15-minute discovery call with <strong>Kenneth (Jeff) Kohler, founder of TrustOffice</strong> — Kenneth is his legal name, Jeff is what everyone calls him — is scheduled for today.</p>
...
Just a quick heads-up that your 15-minute discovery call with Kenneth (Jeff) Kohler, founder of TrustOffice — Kenneth is his legal name, Jeff is what everyone calls him — is scheduled for today.
