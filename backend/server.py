...
# ==================== HELPER FUNCTIONS ====================
# All helper functions have been moved to dependencies.py:
...
# MIGRATED TO: /app/backend/routers/preferences.py
# Endpoints: GET/PUT /notifications/preferences, GET/PUT /user/preferences
