...
class MinutesType(str, Enum):
    ...
    solvency = "solvency"
    general = "general"
    # Template-specific types (added 2026-08-25 to support all 37 minutes templates)
    ...
    spending_authorization = "spending_authorization"
    ...
    # Aliases: template_type names that map to existing enum values
    annual_review = "annual_review"
    quarterly_review = "quarterly_review"
