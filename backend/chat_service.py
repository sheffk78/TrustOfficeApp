...
def _format_knowledge_context(user_message: str = "", intent: str = "") -> str:
    ...
    topic_keywords = {
        ...
        # --- State-specific compliance: Phase B expansion (40 additional states) ---
        "18-state-compliance-alabama": ["alabama", "al compliance", "al trust", "alabama trust code", "form 41"],
        "18-state-compliance-alaska": ["alaska", "ak compliance", "ak trust", "alaska trust", "alaska asset protection"],
        "18-state-compliance-arkansas": ["arkansas", "ar compliance", "ar trust", "arkansas trust code", "form ar1002f"],
        "18-state-compliance-colorado": ["colorado", "co compliance", "co trust", "colorado trust", "form 105"],
        "18-state-compliance-connecticut": ["connecticut", "ct compliance", "ct trust", "connecticut trust", "form ct-1041"],
        "18-state-compliance-georgia": ["georgia", "ga compliance", "ga trust", "georgia trust", "form 501"],
        "18-state-compliance-hawaii": ["hawaii", "hi compliance", "hi trust", "hawaii trust", "form n-40"],
        "18-state-compliance-idaho": ["idaho", "id compliance", "id trust", "idaho trust", "form 66"],
        "18-state-compliance-indiana": ["indiana", "indiana compliance", "indiana trust", "form it-41"],
        "18-state-compliance-iowa": ["iowa", "ia compliance", "ia trust", "iowa trust", "form ia 1041"],
        "18-state-compliance-kansas": ["kansas", "ks compliance", "ks trust", "kansas trust", "ksa 58a"],
        "18-state-compliance-kentucky": ["kentucky", "ky compliance", "ky trust", "kentucky trust", "form 741"],
        "18-state-compliance-louisiana": ["louisiana", "la compliance", "la trust", "louisiana trust code", "form it-541"],
        "18-state-compliance-maine": ["maine", "maine trust", "maine compliance", "form 1041me", "18-b"],
        "18-state-compliance-maryland": ["maryland", "md compliance", "md trust", "maryland trust act", "form 504"],
        "18-state-compliance-massachusetts": ["massachusetts", "ma compliance", "ma trust", "massachusetts trust", "mgl 203e"],
        "18-state-compliance-michigan": ["michigan", "mi compliance", "mi trust", "michigan trust code", "form mi-1041"],
        "18-state-compliance-minnesota": ["minnesota", "mn compliance", "mn trust", "minnesota trust", "form m2"],
        "18-state-compliance-mississippi": ["mississippi", "ms compliance", "ms trust", "mississippi trust", "form 81-100"],
        "18-state-compliance-missouri": ["missouri", "mo compliance", "mo trust", "missouri trust", "form mo-1041"],
        "18-state-compliance-montana": ["montana", "mt compliance", "mt trust", "montana trust", "montana asset protection"],
        "18-state-compliance-nebraska": ["nebraska", "ne compliance", "nebraska trust", "form 1041n"],
        "18-state-compliance-new-hampshire": ["new hampshire", "nh compliance", "nh trust", "new hampshire trust", "nh perpetuity"],
        "18-state-compliance-new-jersey": ["new jersey", "nj compliance", "nj trust", "new jersey trust", "nj inheritance tax"],
        "18-state-compliance-new-mexico": ["new mexico", "nm compliance", "nm trust", "new mexico trust", "form fid-1"],
        "18-state-compliance-north-carolina": ["north carolina", "nc compliance", "nc trust", "north carolina trust", "form d-407"],
        "18-state-compliance-north-dakota": ["north dakota", "nd compliance", "nd trust", "north dakota trust"],
        "18-state-compliance-ohio": ["ohio", "oh compliance", "oh trust", "ohio trust code", "form it 1041"],
        "18-state-compliance-oklahoma": ["oklahoma", "oklahoma trust", "oklahoma compliance", "oklahoma trust code", "form 513"],
        "18-state-compliance-oregon": ["oregon", "oregon trust", "oregon compliance", "form or-41", "ors 130"],
        "18-state-compliance-pennsylvania": ["pennsylvania", "pa compliance", "pa trust", "pennsylvania trust", "pa inheritance tax"],
        "18-state-compliance-rhode-island": ["rhode island", "ri compliance", "ri trust", "rhode island trust", "form ri-1041"],
        "18-state-compliance-south-carolina": ["south carolina", "sc compliance", "sc trust", "south carolina trust", "form sc1041"],
        "18-state-compliance-tennessee": ["tennessee", "tn compliance", "tn trust", "tennessee trust", "hall tax"],
        "18-state-compliance-utah": ["utah", "ut compliance", "ut trust", "utah trust", "form tc-41"],
        "18-state-compliance-vermont": ["vermont", "vt compliance", "vt trust", "vermont trust", "form fit-161"],
        "18-state-compliance-virginia": ["virginia", "va compliance", "va trust", "virginia trust", "form 770"],
        "18-state-compliance-west-virginia": ["west virginia", "wv compliance", "wv trust", "west virginia trust", "form it-141"],
        "18-state-compliance-wisconsin": ["wisconsin", "wi compliance", "wi trust", "wisconsin trust", "chapter 701"],
        "18-state-compliance-wyoming": ["wyoming", "wy compliance", "wy trust", "wyoming trust", "wyoming dynasty trust"],
