...
import { LayoutDashboard, FilePen, Settings, HeartPulse, Coins, Wallet, TrendingUp, MessageSquare } from 'lucide-react';
...
const mainNav = [
  ...
  { path: '/trust-assistant', icon: MessageSquare, label: 'Assistant' },
