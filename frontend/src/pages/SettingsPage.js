...
// Trust protector powers — single source of truth is backend/data/trust_protector_powers.json.
// This constant is AUTO-GENERATED by backend/scripts/generate_trust_protector_powers.py.
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    ...
                    <span className="block text-xs text-gold mt-1">Available for paid, gift, and free-forever accounts</span>
                  </p>
                </div>
                <Switch
