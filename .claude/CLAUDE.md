...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-06 (commit cece0fc). Confidence: 99%.
...
- `backend/dependencies.py` — 20 bug fixes, last fix yesterday (bug magnet); 27 commits/90d
- `frontend/src/pages/OnboardingPage.js` — 20 bug fixes, last fix 2 weeks ago (bug magnet); 27 commits/90d
- `backend/routers/minutes.py` — 16 bug fixes, last fix today (bug magnet); 26 commits/90d

### Code health
Three co-equal signals: defect risk 6.55/10 avg, hotspot health 4.16/10 (stable), worst `frontend/src/context/AuthContext.js` at 1.56/10 · maintainability 7.62/10 · performance risk 54 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `backend/routers/schedule_a.py` — prior defect — impact −2.0
