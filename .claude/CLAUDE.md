...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-05 (commit 407024d). Confidence: 99%.
...
- `frontend/src/pages/DashboardPage.js` — 22 bug fixes, last fix 12 days ago (bug magnet); 35 commits/90d
- `backend/dependencies.py` — 20 bug fixes, last fix today (bug magnet); 26 commits/90d
- `frontend/src/pages/OnboardingPage.js` — 20 bug fixes, last fix 2 weeks ago (bug magnet); 26 commits/90d
- `backend/routers/minutes.py` — 15 bug fixes, last fix today (bug magnet); 24 commits/90d

### Code health
Three co-equal signals: defect risk 4.88/10 avg, hotspot health 2.37/10 (stable), worst `backend/dependencies.py` at 1.0/10 · maintainability 6.62/10 · performance risk 37 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `frontend/src/pages/AdminPage.js` — nested complexity (AdminPage) — impact −2.0
